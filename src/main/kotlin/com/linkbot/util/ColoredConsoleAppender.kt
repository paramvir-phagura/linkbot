...
class ColoredConsoleAppender(name: String, filter: Filter?, layout: Layout<out Serializable>, ignoreExceptions: Boolean)
    : AbstractAppender(name, filter, layout, ignoreExceptions, null)
{
    override fun append(e: LogEvent)
    {
        ...
        when (e.level)
        {
            Level.INFO  -> println(ansi().a("$className - ").fgGreen().a(e.message.formattedMessage).fgDefault())
            Level.WARN  -> println(ansi().a("$className - ").fgYellow().a(e.message.formattedMessage).fgDefault())
            Level.ERROR -> println(ansi().a("$className - ").fgRed().a(e.message.formattedMessage).fgDefault())
            Level.DEBUG -> println(ansi().a("$className - ${e.message.formattedMessage}"))
    ...
    companion object
    {
        ...
        fun createAppender(
            ...
            @PluginElement("Filter") filter: Filter?): ColoredConsoleAppender =
